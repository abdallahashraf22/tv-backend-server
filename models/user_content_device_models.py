...
class Content(Base):
    ...
    watched_user = relationship("User", secondary=user_watched_content_association, back_populates="watched_content")
    favourited_user = relationship("User", secondary=user_favorite_content_association,
                                   back_populates="favourite_content")

    genres = relationship("Genre", secondary=content_genre_association, back_populates="content")
...
class Genre(Base):
    ...
    content = relationship("Content", secondary=content_genre_association, back_populates="genres")
